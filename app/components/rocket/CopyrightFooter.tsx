...
export default function CopyrightFooter() {
  ...
  const serviceLinks: { label: string; href: string; colorConfig: { base: string; glow: string; grad: string } }[] = [
    ...
    { label: 'YouTube Pipeline',                  href: '/youtube-content-id', colorConfig: { base: '#00e5ff', glow: 'rgba(0,229,255,0.35)',   grad: 'linear-gradient(135deg, rgba(0,229,255,0.15), rgba(0,229,255,0.05))' } },
