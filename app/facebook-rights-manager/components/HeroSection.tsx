  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      waves.forEach(wave => {
        ...
        for (let x = 0; x <= w; x += 2) {
          const y = h / 2 + wave.amp * Math.sin(x * wave.freq + t + wave.phase) * Math.sin(t * 0.3 + wave.phase * 0.5);
...
const NavDropdown = () => {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={() => setOpen(o => !o)}
        className="flex items-center gap-2 text-sm font-semibold px-5 py-2.5 rounded-10 transition-all duration-200"
        style={{
...
const PlatformBox = ({ name, icon, color, bg, delay }: { name: string; icon: React.ReactNode; color: string; bg: string; delay: number }) => {
  ...
  return (
    <div
      className="flex flex-col items-center gap-2 p-3 rounded-12 transition-all duration-500"
      style={{
        ...
        animation: pulse ? `platformPulse-${name} 2.5s ease-in-out infinite` : 'none',
        transform: pulse ? 'scale(1.02)' : 'scale(1)',
      }}
    >
      <div
        className="w-10 h-10 rounded-10 flex items-center justify-center"
        style={{
          background: color,
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden" style={{ background: 'linear-gradient(160deg, #0d0d0d 0%, #1a0a04 40%, #0d0d0d 100%)' }}>
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 1 }}>
        <div className="glow-orb w-[700px] h-[700px]" style={{ background: 'rgba(232,93,38,0.10)', top: '-150px', right: '-150px' }} />
        <div className="glow-orb w-[500px] h-[500px]" style={{ background: 'rgba(24,119,242,0.08)', bottom: '-100px', left: '-100px' }} />
        <div className="glow-orb w-[400px] h-[400px]" style={{ background: 'rgba(255,140,66,0.06)', top: '40%', left: '30%' }} />
      </div>
      ...
      {/* Hero Content — pt clears the fixed global navbar */}
      <div className="relative flex-1 flex items-center" style={{ zIndex: 5 }}>
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-24 md:py-28">
          ...
          <div className={`inline-flex items-center gap-3 mb-8 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <div className="flex items-center gap-3 px-4 py-2.5 rounded-full" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)' }}>
              <div className="w-6 h-6 rounded-full overflow-hidden flex items-center justify-center" style={{ background: 'rgba(232,93,38,0.2)', border: '1px solid rgba(232,93,38,0.4)' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-12">
            {/* Left: Text only */}
            <div>
              <p className={`text-sm mb-5 transition-all duration-700 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ color: '#666666' }}>
              ...
              <h1
                className={`font-black text-white mb-6 transition-all duration-700 delay-150 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
                style={{ fontSize: 'clamp(32px, 5vw, 64px)', lineHeight: '1.05', letterSpacing: '-0.04em' }}
              >
                Your music deserves
                <br />
                to be heard.
              ...
              <p className={`text-lg mb-8 max-w-xl transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ color: '#888888', lineHeight: '1.6' }}>
              ...
              {/* Feature highlights */}
              <div className={`space-y-3 transition-all duration-700 delay-250 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                {[
            ...
            {/* Right: Platform boxes at TOP, then partnership card, then ALL 4 stat boxes */}
            <div className={`flex flex-col gap-4 transition-all duration-700 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>

              {/* Platform boxes — at the very top of right column */}
              <div className="w-full">
                ...
                {/* Stats row — continuously incrementing */}
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    <div key={s.label} className="p-2.5 rounded-10 text-center" style={{ background: 'rgba(255,255,255,0.03)', border: `1px solid ${s.color}25` }}>
                      <div className="font-black tabular-nums text-sm" style={{ letterSpacing: '-0.03em', color: s.color }}>{s.value}</div>
              ...
              {/* Partnership card */}
              <div className="relative w-full p-6 rounded-24" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', backdropFilter: 'blur(20px)' }}>
                ...
                <div className="flex items-center justify-center gap-6 mb-4">
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-16 h-16 rounded-20 overflow-hidden flex items-center justify-center" style={{ background: 'rgba(232,93,38,0.15)', border: '2px solid rgba(232,93,38,0.4)', boxShadow: '0 8px 32px rgba(232,93,38,0.3)' }}>
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <div className="text-2xl font-black" style={{ color: '#333' }}>×</div>
                  ...
                  {/* Facebook — glowing animated */}
                  <div className="flex flex-col items-center gap-2">
                    <div
                      className="w-16 h-16 rounded-20 flex items-center justify-center"
                      style={{
                        background: '#1877F2',
                ...
                {/* Partnership note */}
                <div className="p-2.5 rounded-12 text-center" style={{ background: 'rgba(24,119,242,0.08)', border: '1px solid rgba(24,119,242,0.25)' }}>
              ...
              {/* ALL 4 stat boxes — 2x2 grid on the right side */}
              <div className="grid grid-cols-2 gap-3">
                {[
                  {
                    label: 'Music Distribution',
                    icon: (
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e85d26" strokeWidth="1.8">
                  ...
                  },
                  {
                    ...
                    icon: (
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1877F2" strokeWidth="1.8">
                  ...
                  },
                  {
                    ...
                    icon: (
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ff8c42" strokeWidth="1.8">
                  ...
                  },
                  {
                    ...
                    icon: (
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4da6ff" strokeWidth="1.8">
                  ...
                  <div
                    key={box.label}
                    className="p-3 rounded-12 transition-all duration-300"
                    style={{
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1.5">
                      <div className="w-7 h-7 rounded-8 flex items-center justify-center flex-shrink-0" style={{ background: `${box.color}18`, border: `1px solid ${box.color}30` }}>
                        {box.icon}
                      </div>
                      <span className="text-xs font-bold text-white">{box.label}</span>
                    </div>
                    <div className="flex items-baseline gap-1">
                      <span className="font-black tabular-nums text-sm" style={{ color: box.color }}>{box.number}</span>
          ...
          <div
            ...
            style={{ height: '220px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)' }}
          >
            <AudioWaveVisualizer />
            <div className="absolute top-4 left-4 flex items-center gap-2">
              <div className="dot-pulse" style={{ background: '#e85d26', boxShadow: '0 0 0 0 rgba(232,93,38,0.4)' }} />
              <span style={{ color: '#e85d26', fontSize: '11px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase' }}>Live Audio Fingerprinting</span>
            </div>
              ...
              <div className="flex items-center gap-4">
                {[
                  ...
                  <div key={p.label} className="flex items-center gap-1.5">
                    ...
                    <span style={{ color: '#888', fontSize: '11px' }}>{p.label}</span>
                  </div>
                ))}
              </div>
              <span style={{ color: '#444', fontSize: '11px' }}>99.8% Match Accuracy</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        @keyframes platformPulse-Facebook {
          0%, 100% { box-shadow: 0 0 20px rgba(24,119,242,0.3); }
          50% { box-shadow: 0 0 30px rgba(24,119,242,0.6); }
        }
        @keyframes platformPulse-Instagram {
          0%, 100% { box-shadow: 0 0 20px rgba(225,48,108,0.3); }
          50% { box-shadow: 0 0 30px rgba(225,48,108,0.6); }
        }
        @keyframes platformPulse-WhatsApp {
